...
<div style="border:none;position:absolute;left:0px;top:0px;width:100%;height:100%;background-color:white;display:block;">
	<table border="0" width="100%" style="height:100%">
		<tr><td height="100%" valign="middle" align="center" style="text-align:center">
			<div id="bg">
			<div id="splash">
				<span class="version" style="display:none;"><?php echo __('version'); ?> {{APP_VERSION}}</span>
				<span class="website" style="display:none;"><a target="_blank" href="{{PROJECT_SITEURL}}" title="<?php echo __('Visit Project website'); ?>"><?php echo __('Visit Project website'); ?></a></span>
				{{MESSAGE}}
				{{FORM}}
			</div>
			</div>
