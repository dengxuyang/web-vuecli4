 ...
 */
	...
	require_once BASE_PATH . '/../../conf/conf.php';//把用户名 ，密码，数据库存入session;
	Session::init();
	Session::set("db","username",$InitPHP_conf['db']['default'][0]['username']);
	Session::set("db","password",$InitPHP_conf['db']['default'][0]['password']);
	Session::set("db","database",$InitPHP_conf['db']['default'][0]['database']);
	...
	Session::set('db', 'name',$InitPHP_conf['db']['default'][0]['database']);
...
<div class="ui-layout-west">
	...
	<div id="db_combo" class="ui-state-default" style="display:none;">
