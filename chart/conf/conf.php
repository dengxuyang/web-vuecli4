...
$InitPHP_conf['db']['default'][0]['host']                   = "10.106.249.7"; //主机
$InitPHP_conf['db']['default'][0]['username']               = "root"; //数据库用户名
$InitPHP_conf['db']['default'][0]['password']               = "123456"; //数据库密码
$InitPHP_conf['db']['default'][0]['database']               = 'winyeahsdataweb'; //数据库
...
$InitPHP_conf['controller']['module_list']           = array('gthmmc','wyb', 'tomms', 'app' , 'appManager','tbdms','tbdma','tbdma1','tbdma2','twmmp','ottmas','deems','tecmp','daas','gismp','svtgs','tbdma3','lqd','tinms','tcsms','tcpms','timrs','tefms','tigms','trcrs','tepms','tgums','tagrs','temasa','tpoms','tosis', 'omsbda', 'tbdas', 'rws', 'bdmas','bddas','sema', 'demo', 'iimp'); //module白名单
